...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    if(RobotContainer.m_driverController.getAButtonReleased()){
      RobotContainer.m_Blocker.Stop();
    }

    if(RobotContainer.m_driverController.getBButtonPressed()){
      RobotContainer.m_Blocker.SetNoteOutSpd();
    }
